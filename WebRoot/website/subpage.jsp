 ...
 <div class="topimg-news"></div>
	...
	<div class="sinochem_content">
		...
		<div id="dnn_LeftPane" class="content_right">
			...
			<div class="content_1">
				<table style="width: 96%; margin-left: 20px;" border="0" class="titlelist_table" >
						<tr >
							<td>
								<img alt="" src="<%=basePath %>static/resource/images/icon-22.png">&nbsp;&nbsp;&nbsp;
								<a class="f1206"  target="_blank" title="">
								<span>	美国ASI公司高层领导访问..</span>
	            			</a>
							</td>
							<td  nowrap style="width: 1%;"> (远元集团)&nbsp;&nbsp;2017-03-16&nbsp;&nbsp;</td>
							<td  nowrap style="width: 1%;"></td>
						</tr>
						<tr> 
							<td>
								<a class="f1206" href="/content.jsp?urltype=news.NewsContentUrl&amp;wbtreeid=1086&amp;wbnewsid=1750" target="_blank" title="美国ASI公司高层领导访问交大博通">
								<span class="titlestyle1206">	美国ASI公司高层领导访问..<span style="text-decoration:none">
	            			</a>
							</td>
							<td  nowrap style="width: 1%;"> (远元集团)&nbsp;&nbsp;2017-03-16&nbsp;&nbsp;</td>
							<td  nowrap style="width: 1%;"></td>
						 ...
						 <tr >
							...
							<td  nowrap style="width: 1%;"></td>
							<td  nowrap style="width: 1%;"><img src="/image/hot.gif" align="absmiddle" border="0"></td>
						</tr>
						 <tr >
							<td>
								<a class="f1206" href="/content.jsp?urltype=news.NewsContentUrl&amp;wbtreeid=1086&amp;wbnewsid=1750" target="_blank" title="美国ASI公司高层领导访问交大博通">
	...
	function menu(){
		...
		$('#menu li a').click(function(e){
			...
			$('.sideNav li ol').not(dropDown).slideUp(100);
			$(this).parent().toggleClass('liDownHover'); 
