 ...
 <div class="topimg-about"></div>
			...
			<div class="content_right">
				<div class="content_r_breadcrumb">
					<span class="current_position">当前位置：</span>
						...
						<a href="" class="SkinObject">企业愿景</a>
					</span>
				</div>
			<div class="content_1">
    ...
    <tbody>
        <tr>
            ...
            <h1 style="line-height:250%"><h1 id="Title">企业愿景</h1></h1>
	...
	<tr>
       <td>
               <div id="article_content" style="margin-top:15px;">
            	   <div id="Content">
	            		<p class="indent">企业愿景</p>
	            		
					    <p class="indent">近期实现：成为中国脚病修治服务保健行业第一品牌!</p>
						<p class="indent">中期目标：用5-10年完成品牌及实力的积累，成为上市公司!</p>
						<p class="indent">远景追求：成为脚病修治行业国际化知名品牌!</p>
							<p class="indent">&nbsp; </p>
							<p class="indent">&nbsp; </p>
							<p class="indent">&nbsp; </p>
							<p class="indent">	&nbsp; </p>
