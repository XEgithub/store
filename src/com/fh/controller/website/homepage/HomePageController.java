...
public class HomePageController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("HOMEPAGE_ID", this.get32UUID());	//主键
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("MODULAR2NAME"));	    //5
			vpd.put("var6", varOList.get(i).getString("MODULAR2CONTENT"));	    //6
			vpd.put("var7", varOList.get(i).getString("MODULAR3NAME"));	    //7
			vpd.put("var8", varOList.get(i).getString("MODULAR3CONTENT"));	    //8
			vpd.put("var9", varOList.get(i).getString("MODULAR4NAME"));	    //9
			vpd.put("var10", varOList.get(i).getString("MODULAR4CONTENT"));	    //10
			varList.add(vpd);
		}
